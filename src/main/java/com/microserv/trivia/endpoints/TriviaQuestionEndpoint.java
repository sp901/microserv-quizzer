package com.microserv.trivia.endpoints;

import com.microserv.trivia.model.TriviaQuestion;
import com.microserv.trivia.model.TriviaQuestionAccessible;
import com.microserv.trivia.model.TriviaQuestionArrayAccess;
...
final public class TriviaQuestionEndpoint {
    ...
    public Response getQuestions(@Context UriInfo uri, @QueryParam("offset") @DefaultValue("0") long offset)  {
        ...
        // Finally, we'll build and return the JSON response
