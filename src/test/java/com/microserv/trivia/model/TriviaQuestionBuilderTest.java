...
public class TriviaQuestionBuilderTest {
    ...
    /**
     * Want to make sure our builder can't build objects in an inconsistent state
     * So if we can't create the object, we should through a IllegalArgumentException
     */
